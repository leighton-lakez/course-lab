          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">support@courselab.com</p>
                </div>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-4">
                <a href="#" className="bg-blue-100 w-10 h-10 rounded-full flex items-center justify-center hover:bg-blue-200 transition-colors">
